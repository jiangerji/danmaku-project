...
class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        try {
            mShowThirds = attributes.getBoolean(
                    R.styleable.CropImageView_showThirds, false);
            mHighlightColor = attributes.getColor(
    ...
    private void drawHandles(Canvas canvas) {
        ...
        canvas.drawCircle(xMiddle, mDrawRect.bottom, mHandleRadius,
                mHandlePaint);
    }
    ...
    private void drawThirds(Canvas canvas) {
        ...
        canvas.drawLine(mDrawRect.left + xThird, mDrawRect.top, mDrawRect.left
                + xThird, mDrawRect.bottom, mOutlinePaint);
